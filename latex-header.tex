...
%% ------------------------------------------------------------
\newcommand{\OpImageWidthFraction}{0.80}   % Op image width (0.90 = 90% of column width for 2-col layout)
...
\newcommand{\CodeBlockLeadingPt}{11.55}  % Line height (leading) in points (~+10% over 10.5pt)
\newcommand{\CodeBlockLineSpacing}{0.9}  % Extra multiplier (1.0 = none). Keep for fine-tuning.
...
\newcommand{\FooterVerticalOffset}{-10pt} % Vertical offset for page number (negative = closer to page edge)
...
\newcommand{\VideoCardFontSizePt}{13.0}   % Video card font size (pt) (~+15% over 11pt)
\newcommand{\VideoCardLeadingPt}{17.0}    % Video card leading/line-height (pt)
...
\newcommand{\NeedspaceSection}{6\baselineskip}
\newcommand{\NeedspaceSubsection}{5\baselineskip}
\newcommand{\NeedspaceSubsubsection}{4\baselineskip}
\newcommand{\NeedspaceParagraph}{3\baselineskip}
