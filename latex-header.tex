...
\newcommand{\PageMarginLeft}{0.4in}      % Left margin
\newcommand{\PageMarginRight}{0.28in}     % Right margin
\newcommand{\PageMarginTop}{0.26in}       % Top margin
\newcommand{\PageMarginBottom}{0.22in}   % Bottom margin
...
\newcommand{\PageNumberFontSize}{10.4}   % Page number font size
...
\newcommand{\SectionTwoSpacingBefore}{1.0ex}  % Spacing before major sections
\newcommand{\SectionTwoSpacingAfter}{0.9ex}  % Spacing after major sections

\newcommand{\SectionThreeFontSize}{13.5}    % Subsections (op names)
\newcommand{\SectionThreeLeading}{9}
\newcommand{\SectionThreeSpacingBefore}{0.8ex}  % Spacing before subsections
\newcommand{\SectionThreeSpacingAfter}{1.2ex}  % Spacing after subsections
...
\newcommand{\SectionFourLeading}{10.5}
\newcommand{\SectionFourSpacingBefore}{0.4ex}  % Spacing before paragraph headers
\newcommand{\SectionFourSpacingAfter}{0.8ex} 
...
%% ------------------------------------------------------------
\newcommand{\OpImageHeightFraction}{0.055}  % Op image height fraction of \textheight (width scales proportionally)
\newcommand{\OpImageSpacing}{-0.35\baselineskip}  % Spacing before/after op images
...
\newcommand{\OpImageBrightnessOverlay}{0.25}  % Op image brightness overlay (0.0 = no change, 1.0 = fully white). Higher = brighter/lighter for printing


%% ------------------------------------------------------------
%% CODE BLOCKS
%% ------------------------------------------------------------
\newcommand{\CodeBlockFontSize}{11}     % Font size in points
\newcommand{\CodeBlockLeadingPt}{12}  % Line height (leading) in points
\newcommand{\CodeBlockLineSpacing}{1.15}  % Extra multiplier (1.0 = none). Keep for fine-tuning.
\newcommand{\CodeBlockSpacingBefore}{0.85\baselineskip}  % Space before code blocks
\newcommand{\CodeBlockPaddingTop}{7pt}    % Top padding inside code blocks
\newcommand{\CodeBlockPaddingBottom}{6pt} % Bottom padding inside code blocks
\newcommand{\CodeBlockPaddingLeft}{10pt}    % Left padding inside code blocks
