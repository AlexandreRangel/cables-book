...
\newcommand{\PageMarginRight}{0.3in}     % Right margin
...
\newcommand{\PageNumberFontSize}{10.5pt}   % Page number font size
...
\newcommand{\SubsubsectionSpacingBefore}{2.5ex}  % Spacing before subsubsections 
\newcommand{\SubsubsectionSpacingAfter}{1.25ex }  
...
\newcommand{\CodeBlockLeadingPt}{12.0}  % Line height (leading) in points
\newcommand{\CodeBlockLineSpacing}{1.1}  % Extra multiplier (1.0 = none). Keep for fine-tuning.
\newcommand{\CodeBlockSpacingBefore}{0.75\baselineskip}  % Space before code blocks
\newcommand{\CodeBlockPaddingTop}{8pt}    % Top padding inside code blocks
\newcommand{\CodeBlockPaddingBottom}{8pt} % Bottom padding inside code blocks
