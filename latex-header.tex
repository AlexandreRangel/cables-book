...
%% ------------------------------------------------------------
\newcommand{\OpImageWidthFraction}{0.40}   % Op image width fraction of \columnwidth (0.90 = 90% of column)
...
\renewcommand{\includegraphics}[2][]{%
  \isopimage{#2}{%
    ...
    \global\@opimagetrue
    % Use \columnwidth (not \linewidth) so the fraction is stable even inside floats/minipages.
    \noindent\oldincludegraphics[width=\OpImageWidthFraction\columnwidth,keepaspectratio]{#2}%
  }{%
