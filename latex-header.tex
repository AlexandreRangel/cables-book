...
\newcommand{\PageMarginBottom}{0.4in}   % Bottom margin
...
\newcommand{\FooterVerticalOffset}{-18pt}  % Vertical offset for page number (negative = closer to page edge)
\newcommand{\PageNumberGrayPercent}{75}  % Page number color (black!75)
