...
\newcommand{\FooterVerticalOffset}{-5pt} % Vertical offset for page number (negative = closer to page edge)
...
%% TOC: color items to match heading styles
...
\renewcommand{\cftsubsubsecfont}{\color{sectionthreecolor}}
\renewcommand{\cftsubsubsecpagefont}{\color{sectionthreecolor}}
\renewcommand{\cftparafont}{\color{sectionfourcolor}}
\renewcommand{\cftparapagefont}{\color{sectionfourcolor}}
