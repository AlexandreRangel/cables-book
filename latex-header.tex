...
\newcommand{\SectionTwoLeading}{12}

\newcommand{\SectionThreeFontSize}{13.5}    % Subsections (op names)
\newcommand{\SectionThreeLeading}{9}
\newcommand{\SectionThreeSpacingBefore}{1.5ex}  % Spacing before subsections
\newcommand{\SectionThreeSpacingAfter}{1.85ex}  % Spacing after subsections
...
\newcommand{\OpImageSpacing}{-0.4\baselineskip}  % Spacing before/after op images
...
\newcommand{\CodeBlockSpacingBefore}{0.7\baselineskip}  % Space before code blocks
...
\newcommand{\BodyTextLeading}{13.3pt}    % Body text line height (leading) - typically 1.2x font size
...
%% ------------------------------------------------------------
\newcommand{\CardGrayPercent}{9}         % Background gray level (black!10 ~= very light)
