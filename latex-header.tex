...
\newcommand{\OpImageSpacing}{0.25\baselineskip}  % Spacing before/after op images
...
\newcommand{\FooterHeight}{14}          % Footer height in points
...
\titlespacing*{\subsubsection}{0pt}{\SectionThreeSpacingBefore}{0.3ex plus .1ex}
