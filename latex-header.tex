...
%% ------------------------------------------------------------
\newcommand{\OpImageHeightFraction}{0.06}  % Op image height fraction of \textheight (width scales proportionally)
\newcommand{\OpImageSpacing}{0.05\baselineskip}  % Spacing before/after op images
...
\newcommand{\PageMarginTop}{0.3in}       % Top margin
\newcommand{\PageMarginBottom}{0.24in}   % Bottom margin
...
\newcommand{\FooterVerticalOffset}{-6pt} % Vertical offset for page number (negative = closer to page edge)
