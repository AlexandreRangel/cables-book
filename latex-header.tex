...
\newcommand{\CodeBlockLeadingPt}{12.0}  % Line height (leading) in points (~+10% over 10.5pt)
\newcommand{\CodeBlockLineSpacing}{1.0}  % Extra multiplier (1.0 = none). Keep for fine-tuning.
\newcommand{\CodeBlockSpacingBefore}{0.75\baselineskip}  % Space before code blocks (50% of previous 1.5\baselineskip)
...
\newcommand{\PageMarginTop}{0.6in}       % Top margin
...
% Code blocks use the same card style, but with reduced spacing before
